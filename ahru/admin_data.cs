...
namespace ahru
{
    public partial class admin_data : Form
    {
        Thread th;
        ...
        private void view_admin(object obj)
        {
            Application.Run(new view_admin());
        }
        ...
        private void admin_data_Load(object sender, EventArgs e)
        {
        ...
        private void confirmBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd = new SqlCommand("select * from Admin where admin_cnic = '" + cnTxt.Text + "'", MyConnection);
                ...
                else
                {
                    try
                    {
                        ...
                        rg.admin_regis(cnTxt.Text.ToString(), fnTxt.Text.ToString(), lnTxt.Text.ToString(), unTxt.Text.ToString(), paTxt.Text.ToString(), emTxt.Text.ToString(), coTxt.Text.ToString());
                        cnTxt.Clear();
                        fnTxt.Clear();
                        lnTxt.Clear();
                        unTxt.Clear();
        ...
        private void update_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                    try
                    {
                        rg.admin_update(cnTxt.Text.ToString(), fnTxt.Text.ToString(), lnTxt.Text.ToString(), unTxt.Text.ToString(), paTxt.Text.ToString(), emTxt.Text.ToString(), coTxt.Text.ToString());
                        cnTxt.Clear();
                        fnTxt.Clear();
                        lnTxt.Clear();
                        unTxt.Clear();
        ...
        private void delete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    rg.admin_delete(cnTxt.Text.ToString(), fnTxt.Text.ToString(), lnTxt.Text.ToString(), unTxt.Text.ToString(), paTxt.Text.ToString(), emTxt.Text.ToString(), coTxt.Text.ToString());
                    cnTxt.Clear();
                    fnTxt.Clear();
                    lnTxt.Clear();
                    unTxt.Clear();
        ...
        private void search_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                cmd = new SqlCommand("[admin_search]", MyConnection);
                ...
                finally
                {
                    ...
                    {
                        cnTxt.Text = MyDataReader["admin_cnic"].ToString();
                        fnTxt.Text = MyDataReader["admin_Fn"].ToString();
                        lnTxt.Text = MyDataReader["admin_Ln"].ToString();
                        unTxt.Text = MyDataReader["admin_user"].ToString();
                        paTxt.Text = MyDataReader["admin_pass"].ToString();
                        emTxt.Text = MyDataReader["admin_mail"].ToString();
                        coTxt.Text = MyDataReader["admin_cont"].ToString();
                        MyConnection.Close();
                    }
                    else
                    {
        ...
        {
            cmd = new SqlCommand("select * from Admin where admin_pass = '" + paTxt.Text + "'", MyConnection);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(ds);
            int i = ds.Tables[0].Rows.Count;
        ...
        private void emTxt_Leave(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select * from Admin where admin_mail = '" + emTxt.Text + "'", MyConnection);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(ds);
            int i = ds.Tables[0].Rows.Count;
        ...
        private void coTxt_Leave(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select * from Admin where admin_cont = '" + coTxt.Text + "'", MyConnection);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(ds);
            int i = ds.Tables[0].Rows.Count;
